<div class="page-wrapper">
    <div class="content"> 
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><b>Edit Quotation</b></h4>
            </div>
        </div>
         <div class="card-box" style="border-style:ridge">
            <form action="<?php echo base_url('admin/saveDquotation'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:50px;" >
                                                    <input type="number" class="form-control" name="rate<?= $i; ?>" id="rate<?= $i; ?>" onkeyup="calculateWeight(<?= $i;?>)" value="<?= $rate; ?>"  style="width:70px; text-align:center; " <?= ($i == 1 ? "required" : ""); ?> step="any" />
                                                </td>
                                                <td style="width:100px">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align:right;">
                                                Loading Charges  (
                                                    <label>
                                                        <input type="radio" name="loading" id="lchargesyes" onchange="loadingchargeschanged()" value="Yes" <?= $data->loading == "Yes" ? "checked" : ""; ?> />
                                                        Yes
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="loading" id="lchargesno" onchange="loadingchargeschanged()" value="No" <?= $data->loading == "No" ? "checked" : ""; ?> />
                                                        No
                                                    </label>
                                                ): <input type="number" step="any" id="lcharges" name="lcharges" style="width:150px; text-align:right;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->lcharges; ?>" /><br />
                                                Cutting Charges : <input type="number" step="any" id="ccharges" name="ccharges" style="width:150px; text-align:right;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->ccharges; ?>" /><br />
                                                Freight Charges (
                                                    <label>
                                                ...
                                                ): <input type="number" step="any" id="fcharges" name="fcharges" style="width:150px; text-align:right;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->fcharges; ?>" /><br />
                                                Other Charges : <input type="number" step="any" id="ocharges" name="ocharges" style="width:150px; text-align:right;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->ocharges; ?>" /><br />
                                                GST(18%) : <input type="number" step="any" id="gst" name="gst" readonly="true" style="width:150px; text-align:right;border: 0px none;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->gst; ?>" /><br />
                                                Round Off : <input type="number" step="any" id="roundoff" name="roundoff" readonly="true" style="width:150px; text-align:right;border: 0px none;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->roundoff; ?>" /><br />
                                                Total : <input type="number" step="any" id="total" name="total" readonly="true" style="width:150px; text-align:right;border: 0px none;" onkeyup="calculateTotalWeight('no')" min=0 value="<?= $data->total; ?>" /><br />
