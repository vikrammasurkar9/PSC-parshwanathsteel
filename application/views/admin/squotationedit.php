<div class="page-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-sm-8">
                <h4 class="page-title"><b>Edit Single Brand Quotation</b></h4>
            </div>

        </div>

        <div class="card-box" style="border-style:ridge">
            <form action="<?php echo base_url('admin/saveeditedsquotation'); ?>" method="post"
                enctype="multipart/form-data" onsubmit="return confirmSubmit()" name="myForm">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input class="form-control" name="firmname" id="firmname" value="<?= $data->firmname; ?>"
                                    type="text" required />
                            </div>
                            <div class="col-sm-3">
                                <label>Name</label>
                                <input class="form-control" name="name" id="name" value="<?= $data->username; ?>"
                                    type="text" />
                            </div>
                            <div class="col-sm-3">
                                <label>WhatsApp No. <span class="text-danger">*</span></label>
                                <input type="text" id="mobileno" name="mobileno" class="form-control"
                                    value="<?= $data->mobileno; ?>" required />
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="col-sm-3"> 
                            <label>Enquiry Ref.[Narration]</label>
                                <input class="form-control" name="narration" id="" value="<?= $data->narration; ?>"
                                    type="text">
                            </div>
                            ...
                            <table class="table table-bordered table-striped custom-table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                            ...
                                                            foreach($productvarietylist as $row){
                                                                if($pid == $row->pid){
                                                                    ...
                                                                    if($pwid == $row->id)
                                                                        $selected = "selected";
                                                            ?>
                                                <option weight='<?= $row->weight; ?>' value='<?= $row->id ?>'
                                                    <?= $selected; ?>><?= $row->sizeinmm; ?></option>
                                                <?php  }}} ?>
                                            </select>
                                        </td>
                                                                ...
                                                                foreach($brands as $row){
                                                                    if($pwid == $row->pwid){
                                                                        ...
                                                                        if($brandid == $row->bid)
                                                                            $selected = "selected";
                                                                ?>
                                                <option billingrate="<?= $row->billingrate ?>" value="<?= $row->bid ?>"
                                        ...
                                        <td style="width:50px;">
                                            <input type="number" class="form-control" name="rate<?= $i; ?>"
                                                id="rate<?= $i; ?>" onkeyup="calculateWeight(<?= $i;?>)"
                                                value="<?= $rate; ?>" style="width:70px; text-align:center; "
                                                <?= ($i == 1 ? "required" : ""); ?> step="any" />
                                        </td>
                                        <td style="width:100px">
                                            <input type="number" class="form-control" id="totalAmount<?= $i; ?>"
                                                name="totalAmount<?= $i; ?>" style="width:100px; text-align:center;"
                                                value="<?= $amount; ?>" tabindex=-1 readonly />
                                        </td>
                                        <td style="width:100px">
...
function Reset(i) {
    ...
    // var dropDown2 = document.getElementById("brand" + i);
