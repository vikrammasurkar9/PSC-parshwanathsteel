<div class="page-wrapper">
    <div class="content">
        <form action="<?php echo base_url('admin/saveRequest'); ?>" method="post" enctype="multipart/form-data"
            ...
            <div class="row">
                <div class="col-sm-12 mb-3">
                    ...
                    <select id="firmid" name="firmid" class="form-control" onchange="firmChange()">
            ...
            <div class="card-box" style="border-style:ridge" id="mainbox" >
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:180px;">
                                                <select class="form-control" id="pwid<?= $i; ?>" name="pwid<?= $i; ?>"
                                                    onchange="copyWeight(this, <?= $i;?>)">
                                                    <option value="">Select</option>
                                                </select>
                                            </td>
                                            <td style="width:100px;">
                                                <select name="unit<?= $i; ?>" id="unit<?= $i; ?>" class="form-control"
                                                    onchange="calculateWeight(<?= $i;?>)">
                                                </select>
                                            </td>
                                            <td style="width:50px;">
                                                ...
                                                <input type="number" class="form-control" step="any"
                                                    name="quantities<?= $i; ?>" id="quantities<?= $i; ?>"
                                                    onkeyup="calculateWeight(<?= $i;?>)" value=""
                                                    style="width:70px; text-align:center; " />
                                            </td>
                                            <td style="width:100px">
                                                <input type="text" class="form-control" id="totalweight<?= $i; ?>"
                                                    name="weight<?= $i; ?>" style="width:100px; text-align:center; "
                                                    onkeyup="copyWeightToSingle(<?= $i; ?>)"
