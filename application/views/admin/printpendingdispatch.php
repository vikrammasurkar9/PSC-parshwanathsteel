...
<button class="btn btn-success pull-right" onclick="sendonwhatsapp('printDiv_Invoice')" style="margin-left:10px"> <i class="fa fa-whatsapp fa-lg"></i> Send</button>
                ...
                <a href="<?= base_url('admin/dispatch/'.$orderid ); ?>" style="color:white"> <i class="fa fa-plus fa-lg"></i> New Dispatch </a></button>
                        ...
                        <tr style="width:100%;">
                            ...
                            <table>
                                    ...
                                    <?php $orderno = substr("000{$data->orderno}", -4); ?>
                                        ...
                                        <td style="border:none;text-align:left"><b>PIPL/<?= $orderno; ?> /<?= date("d-m-y", strtotime($data->createdon)); ?> </b></td>
                                    </tr>
                                    <tr style="border:none">
                    ...
                    <table style="width:100%; border: 1px solid black;border-collapse: collapse; font-size:medium;">
                        <thead>
                            <tr>
                                ...
                                <th style="border: 1px solid black;border-collapse: collapse;padding-right:10px; text-align:right;">Total Qty</th>
                                <th style="border: 1px solid black;border-collapse: collapse;padding-right:10px; text-align:right;">Pending Qty</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                for($i=1;$i<=count($result);$i++){
                                    ...
                                    ?>
                                <tr>
                                    <td style="border: 1px solid black;border-collapse: collapse;text-align: center; padding:5px;"><?php echo $i; ?></td>
                                    ...
                                    <td style="border: 1px solid black;border-collapse: collapse;padding-right:10px; text-align:right;"><?= $row->billingin == "Kgs" ? number_format($quantity, 1)."  ".$row->billingin : $quantity."  ".$row->billingin; ?></td>
                                    <td style="border: 1px solid black;border-collapse: collapse;padding-right:10px; text-align:right;"><?= $row->billingin == "Kgs" ? number_format($total, 1)."  ".$row->billingin : $total."  ".$row->billingin; ?></td>
