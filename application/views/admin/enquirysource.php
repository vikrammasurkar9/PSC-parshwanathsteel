    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-6 col-lg-6">
                <h4 class="page-title">Enquiry Sources</h4>
            </div>
            <div class="col-md-6">
        ...
        <div class="card-box">
            <div class="row">
                <div class="col-lg-6" style="border-style: solid;border-color:#b2dcf4;padding:20px;">
                    <form action="<?php echo base_url('admin/saveenquirysource'); ?>" method="post"
                        ...
                        <table class="table table-striped custom-table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?= base_url('admin/enquirysource/'.$row->id);?>" ><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
                                        <a href="<?php echo base_url('admin/deleteenquirysource/' . $row->id); ?>"
