                            ...
                            <tr>
                                ...
                                <?php
                                    foreach ($producers as $producer) { 
                                        echo "<th style='border: 2px solid gray;border-collapse: collapse;text-align:center'>" . $producer->name . "</th>";
                                } ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                foreach ($result as $row) {
                                    ...
                                    ?>
                                <tr>
                                    <td style="border: 2px solid gray;border-collapse: collapse;text-align: center;vertical-align:top;"><?php echo $count; ?></td>
                                    <td style="border: 2px solid gray;border-collapse: collapse;padding-left:2px;vertical-align:top;"><?= $row->productname; ?></td>
                                    <td style="border: 2px solid gray;border-collapse: collapse;padding-left:2px;vertical-align:top;"><?= $row->sizeinmm; ?></td>
                                    <td style="border: 2px solid gray;border-collapse: collapse;padding-right:5px; text-align:right;vertical-align:top;"><?= $row->estimationin == "Kgs" ? "" : $row->quantities; ?></td>                                   
                                    <td style="border: 2px solid gray;border-collapse: collapse;padding-left:2px;vertical-align:top;"><?= $row->estimationin; ?></td>
                                    <td style="border: 2px solid gray;border-collapse: collapse;padding-right:2px; text-align:right;vertical-align:top;"><?= $row->billingin == "Kgs" ? number_format($row->weight, 1)."  ".$row->billingin : $row->quantities."  ".$row->billingin; ?></td>
                                    
                                    <?php
                                                foreach ($producers as $producer) {
                                                    echo "<td style='border: 1px solid gray;border-collapse: collapse;padding-right:2px; text-align:right;padding: 0; margin: 0;vertical-align:top;'>";
                                                    echo "<table style='width:100%;border-collapse: collapse;border: 1px solid gray;padding:0px; margin: 0px;' >";
                                                                    ...
                                                                    if($brandproduct->pwid == $row->pwid && $brandproduct->pwid == $row->pwid){
                                                                        ...
                                                                        foreach ($quotationbrandprices as $qbp) {
                                                                            ...
                                                                            if($qbp->bid == $brand->id && $qbp->pwid == $row->pwid && $qbp->rate > 0)
                                                                            {
                                                                                ...
                                                                                echo "<td style='width:40%;padding:8px; text-align:left; border: 2px solid gray; border-collapse: collapse'>" . $brand->name . "</td>";
                                                                                echo "<td style='width:30%;padding:8px; text-align:right;border: 2px solid gray;border-collapse: collapse'> <span style='font-style:bold'> &#8377;" . number_format($qbp->rate, 2)."/". $row->billingin. "</span> </td>";
                                                                                echo "</tr>";
                                                                                $qbpcount++;
