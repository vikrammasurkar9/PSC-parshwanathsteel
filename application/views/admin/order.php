<div class="page-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><b>Delivery Order</b></h4>
            </div>
        </div>
        <div class="card-box" style="border-style:ridge">
            <form action="<?php echo base_url('admin/saveOrder'); ?>" method="post" enctype="multipart/form-data"
                autocomplete="off" onsubmit="return  confirmSubmit();">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="number" id="mobileno" name="mobileno" class="form-control" value="" required />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input class="form-control" name="paymentdetails" id="paymentdetails" placeholder=""
                                value="" type="text" />
                        </div>
                        <div class="col-sm-3">
