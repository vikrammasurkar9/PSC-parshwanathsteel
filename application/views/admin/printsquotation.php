...
?>
            ...
            <div class="col-sm-9 text-right">
                ...
                <?php
					if(!isset($_GET["printamount"]))
					{
                        ...
                        echo '<a href="'.base_url("admin/printsquotation/$id").'?printamount=no">
						<span class="custom-badge status-green" style="padding:10px;"><b>Print Without Amount</b></span>
					</a>';
					}
					else{
						echo '<a href="'.base_url("admin/printsquotation/$id").'">
                ...
                <button class="btn btn-success pull-right" onclick="sendonwhatsapp('printDiv_Invoice')"
                    style="margin-left:20px" id="btnwhatsapp"> <i class="fa fa-whatsapp fa-lg"></i> Send</button>
                <button class="btn btn-success pull-right" onclick="saveAsImage('printDiv_Invoice')"
                    style="margin-left:20px"> <i class="fa fa-file-image-o fa-lg"></i> Image</button>
                <!-- <button class="btn btn-success" onclick="saveAsPDF('printDiv_Invoice')" style="margin-right:20px"> <i class="fa fa-file-pdf-o fa-lg"></i> PDF</button>             -->
                <button class="btn btn-success pull-right" onclick="printDiv('printDiv_Invoice')" style=""> <i
                        class="fa fa-print fa-lg"></i> Print</button>
                <a class="btn btn-success pull-right" href="<?= base_url("admin/printproforma/".$id); ?>"
                    style="color:white;margin-right:10px">Profarma</a>
                ...
                <div style="border-style:groove;padding:10px;">
                    ...
                    <table style="width:100%">
                        <tr class="border_bottom" style="width:100%;">
                            ...
                            <td style="width:50%;text-align:right;margin-right:100px;vertical-align:top;"><br />
                                <b>Quotation Date : <?= date("d-m-Y", strtotime($data->createdon)); ?> <br />
                                    <?php $qno = substr("000{$data->sbqno}", -4); ?>
                                    <h5>Quotation No :
                                        PIPL/SBQ/<?= $qno; ?>/<?= date("d-m-y", strtotime($data->createdon)); ?></h5>
                                </b>
                    ...
                    <table style="width:100%; border: 2px solid gray;border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th style="border: 2px solid gray;border-collapse: collapse;padding-left:10px">Prooduct
                                </th>
                                <th style="border: 2px solid gray;border-collapse: collapse;padding-left:10px">Size
                                </th>
                                ...
                                <th
                                    style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;">
                                    Rate</th>
                                <!-- <th style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;">Amount</th> -->
                                <?php
                                    if(!isset($_GET["printamount"]))
                                    {
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach ($result as $row) {
                                    ?>
                            <tr>
                                <td style="border: 2px solid gray;border-collapse: collapse;text-align: center">
                                    <?php echo $count; ?></td>
                                ...
                                <!-- <td style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;"><?= number_format($row->weight, 1)." Kg"; ?></td> -->
                                <td
                                    style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;">
                                ...
                                <td
                                    style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;">
                                    <?= " &#8377 ". number_format($rate, 2)."/". $row->billingin; ?></td>
                                <?php
                                    if(!isset($_GET["printamount"]))
                                    {
                            ...
                            <tr>
                                ...
                                <td
                                    style="border: 2px solid gray;border-collapse: collapse;padding-right:10px; text-align:right;">
                                    <b><?= number_format($data->totalweight, 1)." Kg"; ?></b>
                                </td>
                    ...
                    <tr style="width:100%">
                        <td style="width:100%;text-align:center" colspan=2>
                            <hr style="background-color:gray">
                            <img src="<?= base_url('assets/icon/tata.png'); ?>" alt="" height="35"
                                style="margin-right:45px;margin-left:10px   ">
                            <img src="<?= base_url('assets/icon/tata-pipes.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/Steel_Authority_of_India.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/am.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/Jindal_Steel_and_Power.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/vizag-steel.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/JSW.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <img src="<?= base_url('assets/icon/rajuri.png'); ?>" alt="" height="35"
                                style="margin-right:45px">
                            <br><br>
                    ...
                    <tbody>
                        ...
                        <tr style="width:100%">
                            <td colspan="2" style="width:100%;text-align:center">
                                ...
                                <img src="<?= base_url('assets/icon/tata-pipes.png'); ?>" alt="" height="35"
                                    style="margin-right:45px">
                                <img src="<?= base_url('assets/icon/Steel_Authority_of_India.png'); ?>" alt=""
                                    height="35" style="margin-right:45px">
                                <img src="<?= base_url('assets/icon/am.png'); ?>" alt="" height="35"
                                    style="margin-right:45px">
                                <img src="<?= base_url('assets/icon/Jindal_Steel_and_Power.png'); ?>" alt="" height="35"
                                    style="margin-right:45px">
        ...
        <?php 
                    $name = $_COOKIE['name'];
                    // if($name == "ChetanOswal" || $name =="Mahesh"){
                ?>
        <a class="btn btn-danger pull-left" href="<?= base_url('admin/editsquotation/'.$id); ?>" style="color:white;"><i
                class="fa fa-arrow-left fa-lg"></i> Edit Single Brand Quotation</a>
        <?php 
//  
?>
        <?php
    ...
    function saveAsImage(divName) {
        html2canvas([document.getElementById(divName)], {
            onrendered: function(canvas) {
                ...
                a.download =
                    '<?= "QT_".substr($data->firmname,0,16)."".date_format(date_create($data->createdon), 'ymd') ?>.jpg';
                a.click();
            }
        });
    }
    ...
    function saveAsPDF(divName) {
        html2canvas([document.getElementById(divName)], {
            onrendered: function(canvas) {
                ...
                var name =
                    '<?= "QT_".substr($data->firmname,0,16)."".date_format(date_create($data->createdon), 'ymd') ?>.pdf';
                doc.save(name);
